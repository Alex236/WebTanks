...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! tslib */ \"./node_modules/tslib/tslib.es6.js\"), __webpack_require__(/*! ./item-base */ \"./src/client/ts/models/item-base.ts\"), __webpack_require__(/*! ./unit-type */ \"./src/client/ts/models/unit-type.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, tslib_1, item_base_1, unit_type_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    var Block = /** @class */ (function (_super) {\n        tslib_1.__extends(Block, _super);\n        function Block(x, y, unitType) {\n            var _this = _super.call(this, x, y, 1, unitType) || this;\n            switch (unitType) {\n                case unit_type_1.UnitType.Road:\n                    _this.sweep = true;\n                    _this.drive = true;\n                    _this.demolish = false;\n                    break;\n                case unit_type_1.UnitType.Brick:\n                    _this.sweep = false;\n                    _this.drive = false;\n                    _this.demolish = true;\n                    break;\n                case unit_type_1.UnitType.HardBrick:\n                    _this.sweep = false;\n                    _this.drive = false;\n                    _this.demolish = false;\n                    break;\n                case unit_type_1.UnitType.Water:\n                    _this.sweep = true;\n                    _this.drive = false;\n                    _this.demolish = false;\n                    break;\n                case unit_type_1.UnitType.Grass:\n                    _this.sweep = true;\n                    _this.drive = true;\n                    _this.demolish = false;\n                    break;\n            }\n            return _this;\n        }\n        return Block;\n    }(item_base_1.ItemBase));\n    exports.Block = Block;\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./src/client/ts/models/block.ts?");
